...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var API_KEY = "AIzaSyDTkiemcyIX57WhpFWpYo2_n8YpOCzqYNo"
            ...
            if (errorObj.dictionaryValue != [:]) {
                ...
                if faceAnnotations != nil {
                    ...
                    for (emotion, total) in emotionTotals {
                        ...
                        if self.topResults != nil && self.topResults.count < 2{
                            self.topResults.append(emotion)
                        }
                        else if self.topResults == nil{
                            self.topResults = [String]()
                            self.topResults.append(emotion)
                        }
                    }
                } else {
                ...
                if numLabels > 0 {
                    ...
                    for index in 0..<numLabels {
                        ...
                        if self.topResults.count < 2{
                            self.topResults.append(label)
                        }
                        labels.append(label)
                    }
                    for label in labels {
